...
export const projects = [
  {
    ...
    about:"This project was built to strengthen my full-stack development skills using the MERN stack. I designed and developed a real-world e-commerce platform where users can browse products, search items, view product details, and add items to cart. It includes a desktop-only Quick View modal, dynamic cart updates using Context API, backend product APIs, and database integration. Through this project, I improved my understanding of API communication, deployment workflows, state management, and responsive UI architecture.",
    challenges:"One major challenge was integrating separately deployed frontend and backend environments while ensuring API requests functioned correctly in production. Another difficulty was designing a clean yet premium UI for an e-commerce platform, since achieving the right balance between simplicity, elegance, and usability required multiple design iterations and research from modern design references. Additionally, managing dynamic cart state efficiently without causing unnecessary component re-renders required careful state architecture planning.",
    solutions:"I resolved deployment issues by configuring environment-based API URLs and properly connecting the Vercel frontend with the Render backend. For state management, I implemented React Context API to handle global cart logic efficiently and prevent prop drilling, ensuring smooth updates with minimal re-renders. To finalize the UI, I studied modern e-commerce design patterns, refined spacing, typography, and hover interactions, and iterated through multiple layouts until achieving a clean, responsive, and professional interface across devices."
    image: image13,
